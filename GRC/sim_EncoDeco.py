...
# Generated: Tue May 23 21:52:55 2017
##################################################
...
class sim_EncoDeco(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sim_EncoDeco")
        ...
        self.connect((self.blks2_packet_decoder_0, 0), (self.vocoder_ulaw_decode_bs_0, 0))
        ...
        self.connect((self.vocoder_ulaw_encode_sb_0, 0), (self.blks2_packet_encoder_0, 0))
...
def main(top_block_cls=sim_EncoDeco, options=None):
