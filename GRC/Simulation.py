...
# Generated: Mon May  1 18:30:23 2017
##################################################
...
class Simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_sink_0_0 = blocks.wavfile_sink('/home/javier/Documents/Santiago/ProyectoWC/FP_2017_I/WComm/GRC/audio_Tx', 1, int(audio_sr), 8)
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_wavfile_sink_0_0, 0))
