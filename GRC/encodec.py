...
class encodec(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "encodec simulation")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("encodec simulation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "encodec")
        ...
        self.controls_grid_layout_0.addWidget(self._qtgui_time_sink_x_0_win,  0,0,1,1)
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_float*1, 'fmdemod.dat', True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'data_in.dat', False)
        self.blocks_file_sink_1_0 = blocks.file_sink(gr.sizeof_char*1, 'gmskDemod', False)
        self.blocks_file_sink_1_0.set_unbuffered(False)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'encoData', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'DataOut', False)
        ...
        self.connect((self.blocks_file_source_1, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.digital_gmsk_demod_0, 0), (self.blocks_file_sink_1_0, 0))
...
def main(top_block_cls=encodec, options=None):
